...
namespace ThreadedProjectWorkshop1
{
    public partial class frmSearch : Form
    {
        ...
        private void examineeDataGridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //int columnIndex = examineeDataGridView.CurrentCell.ColumnIndex;
            //string ID = examineeDataGridView.Rows[rowIndex].Cells[columnIndex].Value.ToString();
            //Console.WriteLine(examineeID);
